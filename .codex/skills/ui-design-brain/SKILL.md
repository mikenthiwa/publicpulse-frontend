...
description: MUST be used for all frontend/UI component, page, form, dashboard, navigation, and layout work in this repository. Generate production-grade UI using real component patterns and best practices from 60+ documented interface components.
